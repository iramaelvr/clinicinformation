        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::hidden('skills',old('skills'),['class'=>'form-control', 'value'=>'null','']) }}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::hidden('admit_type',old('admit_type'),['class'=>'form-control', '']) }}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::time('admit_time',old('admit_time'),['class'=>'form-control', '']) }}
                            {{ Form::label('admit_time','Check up Time*') }}
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::hidden('ward_no',old('ward_no'),['class'=>'form-control','value'=>'null', '']) }}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::hidden('room_no',old('room_no'),['class'=>'form-control','value'=>'null', '']) }}
