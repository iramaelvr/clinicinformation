        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::text('staff_type',old('staff_type'),['class'=>'form-control', 'required']) }}
                ...
                {{-- <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            {{ Form::select('marital_status', array('Unmarried'=>'Unmarried', 'Married'=>'Married'), old('marital_status'), ['class' => 'form-control marital_status', 'required']) }}
